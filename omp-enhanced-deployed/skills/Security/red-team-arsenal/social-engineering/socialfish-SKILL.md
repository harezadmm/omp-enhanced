---
name: socialfish
description: SOCIALFISH pentesting tool
category: red-team-arsenal/social-engineering
tags: [pentesting, social engineering, kali-linux, socialfish]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y socialfish

# Check installation
which socialfish
socialfish --version || socialfish -h
```
...
- Part of Kali Linux social engineering toolkit
...
- Kali Tools: https://www.kali.org/tools/socialfish/
- Official Documentation: Search for "socialfish official documentation"
