---
name: dirb
description: Directory brute forcer: wordlist-based web fuzzing
category: red-team-arsenal/web-applications
tags: [pentesting, web applications, kali-linux, dirb]
...
- Kali Tools: https://www.kali.org/tools/dirb/
- Official Documentation: Search for "dirb official documentation"
