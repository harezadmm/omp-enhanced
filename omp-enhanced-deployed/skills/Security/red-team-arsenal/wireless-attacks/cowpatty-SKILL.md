---
name: cowpatty
description: COWPATTY pentesting tool
category: red-team-arsenal/wireless-attacks
tags: [pentesting, wireless attacks, kali-linux, cowpatty]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y cowpatty

# Check installation
which cowpatty
cowpatty --version || cowpatty -h
```
...
- Part of Kali Linux wireless attacks toolkit
...
- Kali Tools: https://www.kali.org/tools/cowpatty/
- Official Documentation: Search for "cowpatty official documentation"
