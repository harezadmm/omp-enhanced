---
name: ettercap
description: MITM framework: ARP poisoning, packet manipulation
category: red-team-arsenal/sniffing-spoofing
tags: [pentesting, sniffing spoofing, kali-linux, ettercap]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y ettercap

# Check installation
which ettercap
ettercap --version || ettercap -h
```
...
- Part of Kali Linux sniffing spoofing toolkit
...
- Kali Tools: https://www.kali.org/tools/ettercap/
- Official Documentation: Search for "ettercap official documentation"
