---
name: frida
description: Dynamic instrumentation: runtime code injection, hooking
category: red-team-arsenal/reverse-engineering
tags: [pentesting, reverse engineering, kali-linux, frida]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y frida

# Check installation
which frida
frida --version || frida -h
```
...
- Kali Tools: https://www.kali.org/tools/frida/
- Official Documentation: Search for "frida official documentation"
