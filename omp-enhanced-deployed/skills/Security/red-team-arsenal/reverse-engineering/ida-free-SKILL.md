---
name: ida-free
description: IDA-FREE pentesting tool
category: red-team-arsenal/reverse-engineering
tags: [pentesting, reverse engineering, kali-linux, ida-free]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y ida-free

# Check installation
which ida-free
ida-free --version || ida-free -h
```
...
- Kali Tools: https://www.kali.org/tools/ida-free/
- Official Documentation: Search for "ida-free official documentation"
