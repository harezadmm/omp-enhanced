---
name: oscanner
description: OSCANNER pentesting tool
category: red-team-arsenal/database-assessment
tags: [pentesting, database assessment, kali-linux, oscanner]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y oscanner

# Check installation
which oscanner
oscanner --version || oscanner -h
```
...
- Part of Kali Linux database assessment toolkit
...
- Kali Tools: https://www.kali.org/tools/oscanner/
- Official Documentation: Search for "oscanner official documentation"
