...
> Extracted from CORE.md — load on-demand when infrastructure / network tasks arrive.

## Origin Exposure
- Management panels on non-standard ports (Web SSH, admin dashboards, CI/CD UI)
...
## Wireless
- WPA2/WPA3 handshake, PMKID, evil twin, rogue AP, deauth
