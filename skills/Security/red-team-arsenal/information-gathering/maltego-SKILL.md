---
name: maltego
description: MALTEGO pentesting tool
category: red-team-arsenal/information-gathering
tags: [pentesting, information gathering, kali-linux, maltego]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y maltego

# Check installation
which maltego
maltego --version || maltego -h
```
...
- Kali Tools: https://www.kali.org/tools/maltego/
- Official Documentation: Search for "maltego official documentation"
