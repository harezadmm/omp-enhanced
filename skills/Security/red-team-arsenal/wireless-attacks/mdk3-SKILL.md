---
name: mdk3
description: MDK3 pentesting tool
category: red-team-arsenal/wireless-attacks
tags: [pentesting, wireless attacks, kali-linux, mdk3]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y mdk3
...
- Kali Tools: https://www.kali.org/tools/mdk3/
- Official Documentation: Search for "mdk3 official documentation"
