---
name: modlishka
description: MODLISHKA pentesting tool
category: red-team-arsenal/social-engineering
tags: [pentesting, social engineering, kali-linux, modlishka]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y modlishka

# Check installation
which modlishka
modlishka --version || modlishka -h
```
...
- Kali Tools: https://www.kali.org/tools/modlishka/
- Official Documentation: Search for "modlishka official documentation"
