---
name: blackeye
description: BLACKEYE pentesting tool
category: red-team-arsenal/social-engineering
tags: [pentesting, social engineering, kali-linux, blackeye]
...
```bash
# Kali Linux
sudo apt-get update && sudo apt-get install -y blackeye

# Check installation
which blackeye
blackeye --version || blackeye -h
```
...
- Kali Tools: https://www.kali.org/tools/blackeye/
- Official Documentation: Search for "blackeye official documentation"
