---
name: nikto
description: Web server scanner: 6700+ dangerous files/CGIs, outdated ...
category: red-team-arsenal/web-applications
tags: [pentesting, web applications, kali-linux, nikto]
...
**Description:** Web server scanner: 6700+ dangerous files/CGIs, outdated servers
...
- Kali Tools: https://www.kali.org/tools/nikto/
- Official Documentation: Search for "nikto official documentation"
