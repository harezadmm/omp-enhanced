...
This information could be useful for performing other techniques, such as executing a file with a [Scheduled Task/Job](https://attack.mitre.org/techniques/T1053)(Citation: RSA EU12 They're Inside), or to discover locality information based on time zone to assist in victim targeting (i.e.

**Known users/tools:** Agent Tesla, AppleSeed, Astaroth, AsyncRAT, AvosLocker, Azorult, BADHATCH, BISCUIT, BLUELIGHT, BRONZE BUTLER, Bazar, BeaverTail, BendyBear, Bisonal, C0015
