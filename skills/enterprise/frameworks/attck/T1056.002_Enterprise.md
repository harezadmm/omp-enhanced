...
Adversaries may also mimic common software authentication requests, such as those from browsers or email clients.

**Known users/tools:** Bundlore, Calisto, Cuckoo Stealer, Dok, FIN4, Keydnap, LP-Notes, Metamorfo, Mispadu, MuddyViper, Proton, RedCurl, SILENTTRINITY, XCSSET, iKitten
